...
tar -czf $PWD/templibs/hybrid-pqc/android-arm64-v8a.tar.gz -d $PWD/templibs/hybrid-pqc/android-arm64-v8a
...
tar -czf $PWD/templibs/hybrid-pqc/android-armeabi-v7a.tar.gz -d $PWD/hybrid-pqc/android-armeabi-v7a
...
tar -czf $PWD/templibs/hybrid-pqc/android-x86.tar.gz -d $PWD/templibs/hybrid-pqc/android-x86
...
tar -czf $PWD/templibs/hybrid-pqc/android-x86_64.tar.gz -d $PWD/templibs/hybrid-pqc/android-x86_64
...
tar -czf $PWD/templibs/mobile-go/android-arm64-v8a.tar.gz -d $PWD/templibs/mobile-go/android-arm64-v8a
...
tar -czf $PWD/templibs/mobile-go/android-armeabi-v7a.tar.gz -d $PWD/templibs/mobile-go/android-armeabi-v7a
...
tar -czf $PWD/templibs/mobile-go/android-x86.tar.gz -d $PWD/templibs/mobile-go/android-x86
...
tar -czf $PWD/templibs/mobile-go/android-x86_64.tar.gz -d $PWD/templibs/mobile-go/android-x86_64
